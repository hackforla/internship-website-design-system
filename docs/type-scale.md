...
=== "Desktop"
    ...
    === "Hero Section/H1"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <h1>This is a heading 1 for the Hero Section Desktop Size</h1>
            </div>
        </div>
        <br/>
    ...
    === "Hero Section/p"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="hero-p">This is a paragraph for the Hero Section Desktop Size</p>
            </div>
        </div>
        <br/>
    ...
    === "Hero Section/p/semibold"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="hero-p-semibold">This is a semibold paragraph for the Hero Section Desktop Size</p>
            </div>
        </div>
        <br/>
    ...
    === "Hero Section/p/italic"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="hero-p-italic">This is an italic paragraph for the Hero Section Desktop Size</p>
            </div>
        </div>
        <br/>
    ...
    === "Body/H1"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="body-h1">This is a heading 1 for the Body Section Desktop Size</p>
            </div>
        </div>
        <br/>
        ...
        ```html
            <style>
            --8<-- "_type-scale.scss:body-h1"
            </style>

            <h1>This is a heading 1 for the Body Section Desktop Size<h1>
        ```
    ...
    === "Body/p"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="body-p">This is a paragraph for the Body Section Desktop Size</p>
            </div>
        </div>
        <br/>
    ...
    === "Body/p/semibold"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="body-p-semibold">This is a semibold paragraph for the Body Section Desktop Size</p>
            </div>
        </div>
        <br/>
    ...
    === "Body/p/italic"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="body-p-italic">This is an italic paragraph for the Body Section Desktop Size</p>
            </div>
        </div>
        <br/>
    ...
    === "Body/p/small"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="body-p-small">This is a small paragraph for the Body Section Desktop Size</p>
            </div>
        </div>
        <br/>
    ...
    === "Body/p/small-semibold"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="body-p-small-semibold">This is a small semibold paragraph for the Body Section Desktop Size</p>
            </div>
        </div>
        <br/>
    ...
    === "Body/p/small-italic"
        <div class="btn-grid-1">
            <div class="grid-items type-example">
                <p class="body-p-small-italic">This is a small italic paragraph for the Body Section Desktop Size</p>
            </div>
        </div>
        <br/>
